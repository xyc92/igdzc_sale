...
class igdzc_salespider(scrapy.Spider):
    ...
    def parse_detail(self,response):
        ...
        HouseItem['buildyear']=response.xpath('//div[@class="img-right"]/dl[3]/dd/text()').extract()
        HouseItem['community']=response.xpath('//div[@class="img-right"]/dl[4]/dd/a/text()').extract()
        HouseItem['company']=response.xpath('//div[@class="img-right"]/dl[5]/dd/text()').extract()
        HouseItem['address']=response.xpath('//div[@class="img-right"]/dl[6]/dd/text()').extract()
